    ...
    <div className="space-y-8">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-1">WAF configuration backup and restore.</p>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-10 flex flex-col items-center justify-center min-h-64 border border-white/5 text-center">
        <HardDrive className="w-14 h-14 text-green-400 opacity-30 mb-4" />
        <p className="text-slate-400 font-medium text-lg">Backup & Restore</p>
