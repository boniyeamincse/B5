  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Compliance Report</h1>
          <p className="text-slate-400 mt-1">PCI-DSS, GDPR, and SOC 2 compliance tracking.</p>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-10 flex flex-col items-center justify-center min-h-64 border border-white/5 text-center">
        <ClipboardList className="w-14 h-14 text-yellow-400 opacity-30 mb-4" />
        <p className="text-slate-400 font-medium text-lg">Compliance Report</p>
