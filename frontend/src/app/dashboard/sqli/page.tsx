  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">SQL Injection Protection</h1>
          <p className="text-slate-400 mt-1">Configure and monitor SQL injection defenses.</p>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-10 flex flex-col items-center justify-center min-h-64 border border-white/5 text-center">
        <Database className="w-14 h-14 text-red-400 opacity-30 mb-4" />
        <p className="text-slate-400 font-medium text-lg">SQL Injection Protection</p>
