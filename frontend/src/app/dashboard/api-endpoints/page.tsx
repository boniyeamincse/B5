    ...
    <div className="space-y-8">
      <div className="flex items-start gap-4">
        <div className="p-3 rounded-2xl bg-[#00ffff]/10 shrink-0">
          <Network className="w-7 h-7 text-[#00ffff]" />
        </div>
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">API Endpoints</h1>
          <p className="text-slate-400 mt-1">View and manage discovered API endpoints.</p>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-10 flex flex-col items-center justify-center min-h-64 border border-white/5 text-center">
        <Network className="w-14 h-14 text-[#00ffff] opacity-30 mb-4" />
        <p className="text-slate-400 font-medium text-lg">API Endpoints</p>
