  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Blocked Requests</h1>
          <p className="text-slate-400 mt-1">All requests blocked by the WAF.</p>
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-10 flex flex-col items-center justify-center min-h-64 border border-white/5 text-center">
        ...
        <p className="text-slate-400 font-medium text-lg">Blocked Requests</p>
