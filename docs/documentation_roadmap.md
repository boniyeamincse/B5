...
- [x] 81. Explain the JSON structured logging format generated by Lua.
- [x] 82. Detail how logs are ingested into OpenSearch/Elasticsearch.
- [x] 83. Document the OpenSearch index lifecycle management for WAF logs.
- [x] 84. Explain the calculation of the "Risk Score" for requests.
- [x] 85. Document how to query the raw logs manually via API.
- [x] 86. Detail the structure of Daily, Weekly, and Monthly automated reports.
- [x] 87. Write a guide on integrating B5 logs with Datadog.
- [x] 88. Explain how to send B5 alerts to a Slack channel.
- [x] 89. Document how to send Critical alerts to PagerDuty.
